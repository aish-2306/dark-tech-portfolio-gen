...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 w-full py-4 bg-tech-dark/80 backdrop-blur-md z-50 border-b border-tech-purple/10">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="hidden md:flex space-x-6">
          {[
            ...
            <Link
              ...
              offset={-70}
              duration={500}
              className="flex items-center text-sm text-gray-300 hover:text-tech-blue cursor-pointer transition-colors"
            >
              {item.icon}
              {item.name}
            </Link>
        ...
        <div className="md:hidden">
          ...
          <button className="text-gray-300 hover:text-tech-blue">
