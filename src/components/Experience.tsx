        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            <div className="flex items-center mb-6">
              ...
              <h3 className={`text-2xl font-semibold ${theme === 'light' ? 'text-gray-800' : 'text-white'}`}>Research Work</h3>
            </div>
            
            {/* Research Assistant */}
            <div className={`relative pl-8 border-l ${theme === 'light' ? 'border-tech-purple/20' : 'border-tech-purple/30'} pb-10`}>
              ...
              <div className={`${theme === 'light' ? 'bg-white border border-gray-200 hover:border-tech-purple/30 rounded-lg p-6' : 'tech-card'}`}>
                <h3 className={`text-xl font-semibold ${theme === 'light' ? 'text-gray-800' : 'text-white'} mb-2`}>Research Assistant (Undergraduate)</h3>
                <p className={`mb-2 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>Amrita Vishwa Vidyapeetam</p>
                <div className={`flex items-center ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'} text-sm mb-4`}>
                  <Calendar className="mr-1 h-4 w-4" />
                  <span>May 2024 - Present | Amaravati</span>
                </div>
                
                <ul className={`space-y-3 list-disc pl-5 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>
            ...
            <div className="flex items-center mb-6 mt-12">
              ...
              <h3 className={`text-2xl font-semibold ${theme === 'light' ? 'text-gray-800' : 'text-white'}`}>Internship</h3>
            </div>
            
            <div className={`relative pl-8 border-l ${theme === 'light' ? 'border-tech-blue/20' : 'border-tech-blue/30'}`}>
              <div className="absolute left-0 top-0 w-4 h-4 rounded-full bg-tech-blue -translate-x-2"></div>
              <div className={`${theme === 'light' ? 'bg-white border border-gray-200 hover:border-tech-blue/30 rounded-lg p-6' : 'tech-card border-tech-blue/20 hover:border-tech-blue/40'}`}>
                <h3 className={`text-xl font-semibold ${theme === 'light' ? 'text-gray-800' : 'text-white'} mb-2`}>Full Stack Development Intern</h3>
                <p className={`mb-2 ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>Innomatics Research Labs</p>
                <div className={`flex items-center ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'} text-sm mb-4`}>
                  <Calendar className="mr-1 h-4 w-4" />
